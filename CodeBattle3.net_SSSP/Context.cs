...
namespace StarMarines {
    ...
    {        
        ...
        {
            _uri = $"ws://192.168.1.63:8081/galaxy?token=9477bc6b-93d0-44a0-83c1-65c7c8efdd80";
            _token = "9477bc6b-93d0-44a0-83c1-65c7c8efdd80";
            _botName = "SSSP";
            _debug = debug;

            //_uri = $"http://192.168.1.63:8081/galaxy?token={token}";
            //_token = token;
            //_botName = "SSSP";
            //_debug = debug;
        }
